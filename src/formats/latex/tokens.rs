...
pub(crate) const BUILTIN_BACKSLASHED: phf::Map<&'static [u8], StaticToken> = phf_map!{
    ...
    //Cross,
    //Degree,
    b"Rightarrow" => StaticToken::Implies,
    b"approx" => StaticToken::Approx,
    b"arccos" => StaticToken::ArcCos,
    b"arcsin" => StaticToken::ArcSin,
    b"arctan" => StaticToken::ArcTan,
    b"because" => StaticToken::Because,
    b"bigcap" => StaticToken::Intersection,
    b"bigcup" => StaticToken::Union,
    b"bigodot" => StaticToken::CircleDot,
    b"bigoplus" => StaticToken::CirclePlus,
    b"bigotimes" => StaticToken::CircleTimes,
    b"cap" => StaticToken::Intersection,
    b"cdot" => StaticToken::CenterDot,
    b"cong" => StaticToken::Congruent,
    b"cos" => StaticToken::Cos,
    ...
    b"gnsim" => StaticToken::NotGreaterSim,
    b"gtrsim" => StaticToken::GreaterSim,
    b"in" => StaticToken::Element,
    b"infty" => StaticToken::Infinity,
    b"int" => StaticToken::Integrate,
    b"land" => StaticToken::And,
    b"langle" => StaticToken::LeftAngleBracket,
    b"lceil" => StaticToken::LeftCeiling,
    b"le" => StaticToken::LessEqual,
    b"leq" => StaticToken::LessEqual,
    b"lessgtr" => StaticToken::LessGreater,
    b"lessim" => StaticToken::LessSim,
    b"lfloor" => StaticToken::LeftFloor,
    b"lim" => StaticToken::Limit,
    b"ll" => StaticToken::LessLess,
    b"ln" => StaticToken::Log,
    b"lnot" => StaticToken::Not,
    b"lnsim" => StaticToken::NotLessSim,
    b"log" => StaticToken::Log,
    b"lor" => StaticToken::Or,
    b"mp" => StaticToken::MinusPlus,
    b"nabla" => StaticToken::Del,
    b"ne" => StaticToken::Unequal,
    b"neg" => StaticToken::Not,
    b"neq" => StaticToken::Unequal,
    b"nexists" => StaticToken::NotExists,
    b"ngeq" => StaticToken::NotGreaterEqual,
    b"ngtr" => StaticToken::NotGreater,
    b"nleq" => StaticToken::NotLessEqual,
    b"nless" => StaticToken::NotLess,
    // b"not\gg" => StaticToken::NotGreaterGreater,
    // b"not\in" => StaticToken::NotElement,
    // b"not\ll" => StaticToken::NotLessLess,
    b"notin" => StaticToken::NotElement,
    b"nsubseteq" => StaticToken::NotSubsetEqual,
    b"nsupseteq" => StaticToken::NotSupersetEqual,
    b"odot" => StaticToken::CircleDot,
    b"ominus" => StaticToken::CircleMinus,
    b"oplus" => StaticToken::CirclePlus,
    b"otimes" => StaticToken::CircleTimes,
    b"over" => StaticToken::Divide,
    b"partial" => StaticToken::D,
    b"pi" => StaticToken::Pi,
    b"pm" => StaticToken::PlusMinus,
    b"prod" => StaticToken::Product,
    b"propto" => StaticToken::Proportional,
    b"rangle" => StaticToken::RightAngleBracket,
    b"rceil" => StaticToken::RightCeiling,
    b"rfloor" => StaticToken::RightFloor,
    b"sgn" => StaticToken::Sign,
    b"sim" => StaticToken::Sim,
    b"simeq" => StaticToken::SimEqual,
    b"sin" => StaticToken::Sin,
    b"sinh" => StaticToken::Sinh,
    b"sqrt" => StaticToken::Sqrt,
    b"subset" => StaticToken::Subset,
    b"subseteq" => StaticToken::SubsetEqual,
    b"subsetneq" => StaticToken::NotSubsetEqual,
    b"sum" => StaticToken::Sum,
    b"supset" => StaticToken::Superset,
    b"supseteq" => StaticToken::SupersetEqual,
    b"supsetneq" => StaticToken::NotSupersetEqual,
    b"tan" => StaticToken::Tan,
    b"tanh" => StaticToken::Tanh,
    b"therefore" => StaticToken::Therefore,
    b"times" => StaticToken::Times,
    b"varsubsetneq" => StaticToken::NotSubsetEqual,
...
lazy_static! {
    pub(crate) static ref TOKEN_PREC: HashMap<StaticToken, u32> = hashmap!{
        ...
        // the following will default to multiplication, e.g. 3\ln means 3 * \ln
